...
tags: [nacos, docker, deployment]
---

# Nacos

本文提供 Nacos 的配置示例与配置原因说明。
...
```bash
# 启动 Nacos
cd /app/nacos && docker compose up -d

# 关闭 Nacos
cd /app/nacos && docker compose down
