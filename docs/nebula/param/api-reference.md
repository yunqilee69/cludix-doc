...
<ApiEndpoint
  ...
  requestBody={{
    ...
    fields: [
      ...
      { name: 'sensitive', type: 'boolean', required: false, description: '是否敏感参数' },
      { name: 'builtin', type: 'boolean', required: false, description: '是否内建参数' },
      { name: 'editable', type: 'boolean', required: false, description: '是否允许在批量更新中修改' },
      { name: 'visible', type: 'boolean', required: false, description: '是否在模块查询中可见' },
    ],
    example: {
...
<ApiEndpoint
  ...
  requestBody={{
    ...
    fields: [
      ...
      { name: 'displayOrder', type: 'number', required: false, description: '展示顺序' },
      { name: 'sensitive', type: 'boolean', required: false, description: '是否敏感' },
      { name: 'editable', type: 'boolean', required: false, description: '是否可编辑' },
  ...
  responses={[
    {
      ...
      fields: [
        ...
        { name: 'data.data[].paramKey', type: 'string', description: '参数键' },
        { name: 'data.data[].paramName', type: 'string', description: '参数名称' },
        { name: 'data.data[].dataType', type: 'string', description: '数据类型' },
